...
class TestConvertToAbsoluteUrl(object):
    ...
    def setUp(self):
        self.base_url = "http://classic.yogaglo.com"
    ...
    def test_relative_path_with_slash(self):
        ...
        assert_equals(result, "http://classic.yogaglo.com/kathryn-budig.html")
    ...
    def test_relative_path_utf8_slash(self):
        ...
        result = convert_relative_to_absolute_url(self.base_url, rel_uri)
        assert_equals(result, "http://classic.yogaglo.com/teacher-4-Noah-Maz%C3%A9.html")
