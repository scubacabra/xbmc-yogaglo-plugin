...
class TestXBMCPluginURLFormation(object):
    ...
    def test_parameters_yoga_category_and_url(self):
        ...
        result = form_plugin_url(self.xbmc_plugin_url, query)
        assert_equals(result, 'plugin://yogaglo/default.py?yoga_glo_url=http%3A%2F%2Fclassic.yogaglo.com&yoga_category=2')

    def test_parameters_yoga_category_url_play(self):
        query = {'yoga_category': 2, 'yoga_glo_url': 'http://classic.yogaglo.com',
                 'play': 1}
        result = form_plugin_url(self.xbmc_plugin_url, query)
        assert_equals(result, 'plugin://yogaglo/default.py?play=1&yoga_glo_url=http%3A%2F%2Fclassic.yogaglo.com&yoga_category=2')
    ...
    def test_parameters_yoga_category_url_utf8(self):
        ...
        result = form_plugin_url(self.xbmc_plugin_url, query)
        assert_equals(result, 'plugin://yogaglo/default.py?play=1&yoga_glo_url=http%3A%2F%2Fclassic.yogaglo.com%2Fonline-class-194-by-Noah-Maz%25C3%25A9-on-Anusara.html&yoga_category=2')
